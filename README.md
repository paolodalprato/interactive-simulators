...
| 🔀 [Branching Navigator](./branching-navigator/) | Interactive decision-tree framework for training scenarios and branching narratives | [Open](https://paolodalprato.github.io/interactive-simulators/branching-navigator/branching-navigator.html) | [ZIP](https://github.com/paolodalprato/interactive-simulators/releases/latest/download/branching-navigator-simulator.zip) |
